...
class BulletController(Component):
    ...
    def __remove_bullet(self):
        Constants.EVENT_DISPATCHER.dispatch_event(EventData(EventCategoryType.CollisionManager, EventActionType.RemoveColliderFromQuadTree,[self._parent.get_component(BoxCollider2D)]))
