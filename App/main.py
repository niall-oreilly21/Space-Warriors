...
house_scene = scene_loader.initialise_menu_scene(GameConstants.Scene.HOUSE_SCENE)
...
map_loader.map_load(house_scene, GameConstants.Map.BASE_PATH + GameConstants.Scene.HOUSE_SCENE + GameConstants.Map.JSON_END_PATH)
