...
def load_sound(soundManager):
    ...
    soundManager.load_sound(Constants.Music.POTION_DRINK_SOUND, Constants.MusicFilePath.POTION_DRINK_SOUND_FILEPATH)
    soundManager.load_sound(Constants.Music.ENEMY_DEATH_SOUND, Constants.MusicFilePath.ENEMY_DEATH_SOUND_FILEPATH)
    soundManager.load_sound(Constants.Music.ZAP_SOUND, Constants.MusicFilePath.ZAP_SOUND_FILEPATH)
    soundManager.load_sound(Constants.Music.BULLET_SOUND, Constants.MusicFilePath.BULLET_SOUND_FILEPATH)
    ...
    soundManager.set_sound_volume(Constants.Music.POTION_DRINK_SOUND, 1)
