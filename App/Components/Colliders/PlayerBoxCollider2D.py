...
class CharacterBoxCollider2D(BoxCollider2D):
    ...
    def bounds(self):
        ...
        bounds = Rect(self._transform.position.x, self._transform.position.y + material_source_rect.height / 2 + 10,
    ...
    def clone(self):
        return CharacterBoxCollider2D(self._name)
